...
def load_config() -> dict:
    ...
    cfg.setdefault("x_promo", "Arm｜Arc 链免费发币，手续费 78% 永久归创作者，推广还能分佣 👉 https://arm.yyheart.com/?ref=0x6D80C00F410c448b0dc705a1D104797bA1ca160d")
    cfg.setdefault("x_reply", cfg["x_promo"])
    cfg.setdefault("x_outro", ["Arm · Arc 链免费发币", "手续费 78% 归创作者", "arm.yyheart.com", "链接见帖子和评论区"])
