...
export const USER_AGREEMENT = `欢迎使用心之音（以下简称"本平台"）。请在使用前仔细阅读本协议，使用本平台即表示您同意以下条款。
...
export const PRIVACY_POLICY = `心之音（以下简称"本平台"）非常重视您的隐私。本政策说明我们如何收集、使用和保护您的信息。
  ...
  return (
    <div className="app">
      <div className="navbar">
        ...
        <span className="title">{isPrivacy ? '隐私政策' : '用户协议'}</span>
      </div>
